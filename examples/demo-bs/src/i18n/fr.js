...
const posMessages = defineMessages({
    ...
    dashboardOrderItems: {
        ...
        defaultMessage:
            'par {customer_name}, {nb_items, plural, one {un poster} other {{nb_items} posters}}',
    },
...
const resourcesMessages = defineMessages({
    ...
    commandsName: {
        ...
        defaultMessage:
            '{smart_count, plural, one {Commande} other {Commandes}}',
    },
    ...
    categoriesName: {
        ...
        defaultMessage:
            '{smart_count, plural, one {Catégorie} other {Catégories}}',
    },
    ...
    reviewsName: {
        ...
        defaultMessage:
            '{smart_count, plural, one {Commentaire} other {Commentaires}}',
    },
